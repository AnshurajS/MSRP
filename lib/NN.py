...
class NNModel:
    ...
    def __init__(self, ftrain_TFR, fvalid_TFR, ftest_TFR,
        ...
        self.train_dataset   = U.load_TFdataset(ftrain_TFR, ncores, batch_size,
                                                ...
                                                scalelims, shuffle=True, which='emit')
        ...
        N_train, N_valid, N_test = nbatches

        self.train_batches = ceil(N_train / float(batch_size))
        self.valid_batches = ceil(N_valid / float(batch_size))
        self.test_batches = ceil(N_test / float(batch_size))
    ...
    def train(self, epochs=100, patience=50, save=True, parallel=False):
        ...
        if self.train_flag:
            ...
            self.train_batches   = max(1, self.N_train   // self.batch_size)
            self.valid_batches  = max(1, self.N_valid   // self.batch_size)
